<template>
  <div
    ...
    :class="theme"
  >
    <header class="border-t-14 border-nord-11 no-print">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-2">
        <div>          
          <g-link v-if="theme === 'theme-dark'" to="/">
            <g-image src="../../static/turnes_logo.svg" class="w-48" alt="logo" />
          </g-link>
          <g-link v-else to="/">
            <g-image src="../../static/turnes_logo.svg" class="w-48" alt="logo" />
          </g-link>
        ...
        <div class="block lg:hidden">
          <button
            @click="toggle"
            class="flex items-center px-3 py-2 border rounded border-border-nord-10 hover:text-nord-10 hover:border-nord-10"
          >
            <svg
            ...
            >
              <path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" fill="#BF616A" />
            </svg>
          </button>
        </div>
        <ul
        ...
        >
          ...
          <li>
            <g-link to="/" class="text-copy-primary hover:text-nord-11">Blog</g-link>
          </li>
          <li>
            <g-link to="/about/" class="text-copy-primary hover:text-nord-11">About</g-link>
          </li>

          <li>
            <g-link to="/cv/" class="text-copy-primary hover:text-nord-11">CV</g-link>
          </li>
          <!-- <li>
    ...
    <footer class="bg-nord-0 text-white no-print">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:rafael@turnes.dev" targer="_blank" class="text-nord-6 hover:text-nord-11">
          ...
          <li>
            <a
              ...
              target="_blank"
              class="text-nord-6 hover:text-nord-11"
            >
          ...
          <li>
            <a
              href="https://twitter.com/turnesdev"
              target="_blank"
              class="text-nord-6 hover:text-nord-11"
            >
          ...
          <!-- <li>
            <a href="https://instagram.com" target="_blank" class="text-nord-6 hover:text-nord-11">
